...
export function ConsciousnessHero() {
  return (
    <section
    ...
    >
      ...
      <div className="mx-auto w-full max-w-3xl px-6 text-center">
        ...
        >
          <Button href={consciousnessHero.cta.href} variant="primary">
            {consciousnessHero.cta.label}
          </Button>
        </div>
      </div>
    </section>
