...
import { frequencyQuote } from "@/lib/content/frequency";

export function FrequencyQuote() {
  return (
    <Section className="py-32" aria-label="Abschluss des Frequenzraums">
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <div className="mt-14">
          <Button href={frequencyQuote.cta.href} variant="secondary">
            {frequencyQuote.cta.label}
          </Button>
        </div>
      </div>
    </Section>
