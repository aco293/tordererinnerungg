...
import { symbolsJourney } from "@/lib/content/symbols";

/**
 * Erste Symbolreise: drei Fragen als Einladung zur Kontemplation.
 *
 ...
 */
export function SymbolsJourney() {
  return (
    <Section aria-labelledby="symbols-journey-title">
      <SectionHeading
        eyebrow={symbolsJourney.eyebrow}
        title={symbolsJourney.title}
        id="symbols-journey-title"
      >
      ...
      <ul className="mt-16 grid gap-6 md:grid-cols-3">
        {symbolsJourney.questions.map((question) => (
          <li key={question.id}>
