    ...
    >
      ...
      <div className="mx-auto w-full max-w-3xl px-6 text-center">
        ...
        <p className="mb-6 text-xs font-medium uppercase tracking-[0.4em] text-gold/70 animate-fade-up">
          {earthCosmosHero.eyebrow}
        </p>

        <h1
          id="earth-cosmos-title"
        ...
        >
          <Button href={earthCosmosHero.cta.href} variant="primary">
            {earthCosmosHero.cta.label}
          </Button>
        </div>
      </div>
    </section>
