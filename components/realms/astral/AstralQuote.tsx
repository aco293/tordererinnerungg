...
import { astralQuote } from "@/lib/content/astral";

export function AstralQuote() {
  return (
    <Section className="py-32" aria-label="Abschluss des Raums Astralreisen">
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <div className="mt-14">
          <Button href={astralQuote.cta.href} variant="secondary">
            {astralQuote.cta.label}
          </Button>
        </div>
      </div>
    </Section>
