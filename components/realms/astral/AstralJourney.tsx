...
import { astralJourney } from "@/lib/content/astral";

/**
 * Erste Traumreise: drei Fragen als Einladung zur Kontemplation.
 *
 ...
 */
export function AstralJourney() {
  return (
    <Section aria-labelledby="astral-journey-title">
      <SectionHeading
        eyebrow={astralJourney.eyebrow}
        title={astralJourney.title}
        id="astral-journey-title"
      >
      ...
      <ul className="mt-16 grid gap-6 md:grid-cols-3">
        {astralJourney.questions.map((question) => (
          <li key={question.id}>
