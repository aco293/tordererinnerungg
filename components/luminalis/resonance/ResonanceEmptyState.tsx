...
export function ResonanceEmptyState() {
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 text-center backdrop-blur-sm">
      <h2 className="font-serif text-2xl font-light text-white">
        Noch kein Spiegel sichtbar
      </h2>
      <p className="mx-auto mt-4 max-w-md text-base leading-relaxed text-slate-300/80">
        Der Frequenzspiegel entsteht aus deinen eigenen Weg-Einträgen. Sobald du
        im Dialograum erste Einträge speicherst, werden hier Muster sichtbar.
      </p>
      <div className="mt-8">
