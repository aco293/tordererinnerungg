...
type FrequencyIntelligenceShellProps = {
  title: string;
  subtitle: string;
  intro?: string;
  children: ReactNode;
...
/** Ruhiger Rahmen für die Frequenzintelligenz in der Luminalis-Designsprache. */
export function FrequencyIntelligenceShell({
  title,
  subtitle,
  intro,
  children,
}: FrequencyIntelligenceShellProps) {
  return (
